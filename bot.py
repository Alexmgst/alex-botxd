...
jokes = ["Neulich im Kino Verkäuferin: Das Popcorn süß oder salzig? Er: So wie meine Freundin. Verkäuferin: Hässliche Popcorn haben wir nicht!", "Wenn ein Yogalehrer seine Beine senkrecht nach oben streckt und dabei furzt, welche Yoga Figur stellt er da? Eine Duftkerze.","Was ist der gefährliste Tag für ein Uboot ? -Tag der offen Tür","Wie nennt man einen übergewichtigen Vegetarier? Biotonne.", "Lehrer: So Tom du gehst jetzt vor die Tür dein Gelaber interessiert keinen! Schüler: Dann können sie ja gleich mitkommen!", "Warum freut sich eine Blondine so, wenn sie ein Puzzle nach 6 Monaten fertig hat? – Weil auf der Packung steht: 2-4 Jahre.", "Wie nennen Chinesen einen Oberschenkelbruch? Knacki Knacki nah bei Sacki","Warum macht die Blondiene ihren Jogurt schon im Supermarkt auf?Weil drauf steht hier öffnen","Was steht auf dem Grabstein eines Mathematikers? – Damit hat er nicht gerechnet.","Was sagt ein Hai, nachdem es einen Surfer gefressen hat?- Nett serviert, so mit Frühstücksbrettchen"]
